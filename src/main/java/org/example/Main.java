...
public class Main extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "BanderikGusbot";
    }

    @Override
    public String getBotToken() {
        return "6246760364:AAEm_40RY_z8lENWtoXi-8-EH2KtucVSF2w";
    }
    ...
    public void attachButtons(SendMessage message, Map <String, String> buttons) {
        InlineKeyboardMarkup markup = new InlineKeyboardMarkup();//розмітка клави

        List<List<InlineKeyboardButton>> keyboard = new ArrayList<>();

        for (String buttonName: buttons.keySet()) {//цикл створює кнопки і додає рядки
